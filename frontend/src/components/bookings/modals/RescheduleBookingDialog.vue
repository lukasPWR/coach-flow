  ...
  <Dialog :open="open" @update:open="$emit('update:open', $event)">
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          Wybierz nową datę i godzinę dla swojej rezerwacji.
        </DialogDescription>
      </DialogHeader>
      ...
      <DialogFooter>
        ...
        <Button @click="handleConfirm" :disabled="isLoading || !newDate">
...
const emit = defineEmits<{
  ...
  (e: 'confirm', booking: BookingViewModel, newDate: string): void
}>()

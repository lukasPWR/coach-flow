...
const selectedMuscleGroup = ref<MuscleGroupType | "ALL">(
  (props.filters.muscleGroup as MuscleGroupType) || "ALL"
);
  ...
  <div class="space-y-6">
    <div class="space-y-2">
      ...
      <div class="relative">
        ...
        <Input v-model="searchQuery" placeholder="Szukaj ćwiczenia..." class="pl-8" />
      </div>
    </div>
